...
const parser = StructuredOutputParser.fromZodSchema(z.array(EmployeeSchema) as any);
...
async function generateSyntheticData(): Promise<Employee[]> {
  ...
  return parser.parse(response.content as string) as any;
}
...
async function seedDatabase(): Promise<void> {
  try {
    ...
    const syntheticData: Employee[] = await generateSyntheticData();
